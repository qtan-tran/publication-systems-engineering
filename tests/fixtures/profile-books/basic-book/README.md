...
This is a Publication Systems Engineering project generated with the `basic-book` profile.
...
`basic-book` is a generator-supported profile. Use `config/pse-local.tex` for restrained title-local exceptions rather than editing the shared core or profile package.
